...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#addContract").on("click", function(){
            openDialog("width:900,height:400,winId:'contractList',title:'新增',url: '${pageContext.request.contextPath }/build/addContractNo4Completed',buttons:[{text: '确认',handler:function(){addContract()}}]");
        });

        //增加施工许可证书编号
        $("body").on("click",".addNo",function(){
            openDialog("width:900,height:400,winId:'addNumDialog',title:'新增',url: '${pageContext.request.contextPath }/build/addContractNo4Completed2',buttons:[{text: '确认',handler:function(){addTypeNo()}}]");
        });
        ...
        $("#saveApply").on("click",function(){
            ...
            if(!$("#contractAll").val()){
                $.messager.alert('提示','请添加建设工程规划许可证号','info');
                return;
            };

            if(!$("#estateAll").val()){
                $.messager.alert('提示','请添加施工许可证书编号','info');
                return;
            };
