...
<div class="easyui-tabs" data-options="fit:true,border:false">
    <div title="用户管理">
        <iframe scrolling="auto" frameborder="0"  src="${pageContext.request.contextPath}/users/user" style="width:100%;height:100%;"></iframe>
    </div>
    <div title="中间数据导入">
        <iframe scrolling="auto" frameborder="0"  src="${pageContext.request.contextPath}/users/etl" style="width:100%;height:100%;"></iframe>
    </div>
</div>
