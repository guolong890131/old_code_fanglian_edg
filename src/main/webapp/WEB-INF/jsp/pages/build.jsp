...
<div id="toolbar">
        ...
        <form id="bForm">
            ...
            <label>
                <select  name="searchType">
                    ...
                    <option value="build_name">工程名称</option>
                    <option value="address">建设地址</option>
    ...
    <div class="table-toolbar">
        <button id="addFill" data-url="${pageContext.request.contextPath}/build/buildApply?type=" data-type="add">新增</button>
        <button id="importBuildFill">导入</button>
...
<table id="fieldTble"  data-options="
    ...
    <tr>
        ...
        <th data-options="field:'build_name',width:50">工程名称</th>
        ...
        <th data-options="field:'print_date',width:50">发证日期</th>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        //导入
        $("#importBuildFill").on("click",function(){
            openDialog("title:'批量导入',winId:'importFillDialog',url:'${pageContext.request.contextPath}/uploadBuildExcel/importBuild',buttons:[{text:'下一步',handler:function(){importFillNext()}}],width:570,height:205");
        });
        ...
        $("#deleteFill").on("click",function() {
            ...
            Cmessager.confirm(GV.MESSAGER_TITLE, '确认要删除吗?', function (r) {
                if (r) {
                    $.post(
                            '${pageContext.request.contextPath}/build/deleteBuild',
                            param,
                            function(data){
    ...
    function importFillNext(){
        ...
        openDialog("title:'批量导入',winId:'importFillList',url:'${pageContext.request.contextPath}/uploadBuildExcel/importBuildList',buttons:'none',width:670,height:445");
    ...
    function transferTable(){
        $.get("${pageContext.request.contextPath}/uploadBuildExcel/transferTable",function (data) {
            if(data.success){
    ...
    function edit(index,type){
        ...
        var rowStr =JSON.stringify(row);
        window.location = "${pageContext.request.contextPath}/build/view?type="+type+"&data="+encodeURIComponent(rowStr);
    }
    ...
    function search() {
        var paramObj = {};
        var paramArr = $("#bForm").serializeArray();
        ...
        opts.url="${pageContext.request.contextPath}/build/queryBuild";
