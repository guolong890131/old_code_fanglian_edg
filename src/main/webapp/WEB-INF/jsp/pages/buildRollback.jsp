...
<div class="apply-box">
    <form action="" id="addBuildForm">
                ...
                <td>
                    <label>
                        <input type="text" onblur="validateXSS(this)" placeholder="请输入施工许可证号" name="build_no" id="build_no" class="easyui-validatebox"
                               required="true" value="" <c:if test="${associate}">disabled</c:if>/>
                    </label>
                </td>
            </tr>
            <tr>
        ...
        <div class="apply-btn">
            ...
            <input type="button" class="yellow" value="确定" onclick="addBuild('1',this)"/>
        </div>
    </form>
</div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#addContract").on("click", function () {
            openDialog("width:460,height:400,winId:'contractList',title:'新增',url: '${pageContext.request.contextPath }/build/addContractNoWithBuild',buttons:[{text: '确认',handler:function(){addContract()}}]");
        });
