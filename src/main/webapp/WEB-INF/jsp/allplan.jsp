...
<%--全域规划可建面积  stock_code = 1003--%>
        <div class="newHouseStock">
            <div class="newHouse">
                <div class="title">说明：规划可建面积 =  全部已规划未施工的项目建筑面积</div>
...
<form id="queryValue">
    <input id="stockType" type="hidden" name="stock_code" value="1003">
