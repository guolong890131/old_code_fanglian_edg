...
<%--全域土地可建面积   stock_code = 1002--%>
        <div class="newHouseStock">
            <div class="newHouse">
                <div class="title">说明：土地可建面积 =  全部已出让且未通过建设工程规划许可的土地建设面积</div>
...
<form id="queryValue">
    <input id="stockType" type="hidden" name="stock_code" value="1002">
...
//                console.debug(data.result.list);
    ...
    function queryFullCycleRegionStock(){
        $("#h1001").text(nullData);
        $("#hr1001").text(nullData);
        $("#h1002").text(nullData);
        $("#hr1002").text(nullData);
        var paramObj = {};
