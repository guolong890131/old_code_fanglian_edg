...
var _4a7=$.ajax({url:_4a6[0],dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
    ...
    return _4a7.status=='success'?true:false;
// ----------------end
//return _4a7=="true";
...
_8ec.push("</tbody></table>");
    $(_8e9)[0].innerHTML = _8ec.join(""); //20140114 wc 优化修改
//$(_8e9).html(_8ec.join(""));//原版
    ...
    $.createWin = function (options) {
        ...
        function ajaxSuccess(date) {
            if (options.isIframe && !date) {
                dialog.html('<div style="overflow:hidden;height:'+dialog.height()+'px"><iframe width="100%" height="100%" frameborder="0" id="'+windowId+'_Iframe" src="' + options.url + '" ></iframe></div>');
            } else {
                dialog.html(date);
            }
            $.parser.parse(dialog);
